...
This is a [Node.js](https://nodejs.org/)+ [Express.js] + [MongoDB] project for managing quizTime.
It supports authentication, quiz categories, difficulty levels, quiz timing, and secure APIs.
